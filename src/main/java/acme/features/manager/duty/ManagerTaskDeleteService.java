...
@Service
public class ManagerTaskDeleteService implements AbstractDeleteService<Manager, Duty>{
	...
	public boolean authorise(final Request<Duty> request) {
		...
		final Manager manager=this.repository.findOneTaskById(dutyId).getManager();
